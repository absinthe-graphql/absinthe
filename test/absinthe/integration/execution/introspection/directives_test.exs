defmodule Elixir.Absinthe.Integration.Execution.Introspection.DirectivesTest do
  ...
  test "scenario #1" do
    # Note: @defer, @stream, and @semanticNonNull directives are opt-in
    # and not included in core schemas.
    # They need to be explicitly imported via import_directives.
    ...
    # Opt-in directives are not in core schema
    refute "defer" in directive_names
    refute "stream" in directive_names
    refute "semanticNonNull" in directive_names
  end
end
