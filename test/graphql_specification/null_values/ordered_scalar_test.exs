defmodule GraphQL.Specification.NullValues.OrderedScalarTest do
    ...
    context "to a nullable argument with a default value" do
      ...
      context "(control): if not passed" do
        ...
        it "uses the default value" do
          assert_result {:ok, %{data: o%{"times" => 8}}}, run(@query, Schema)
        end
      ...
      context "if passed" do
        ...
        it "overrides the default and is passed as nil to the resolver" do
          assert_result {:ok, %{data: o%{"times" => 4}}}, run(@query, Schema)
        end
    ...
    context "to a variable with a default value" do
      ...
      context "if not passed (control)" do
        ...
        it "uses the default variable value" do
          assert_result {:ok, %{data: o%{"times" => 24}}}, run(@query, Schema)
        end
      ...
      context "if passed" do
        ...
        """
        it "overrides the default and is passed as nil to the resolver" do
          assert_result {:ok, %{data: o%{"times" => 4}}}, run(@query, Schema, variables: %{"mult" => nil})
        end
