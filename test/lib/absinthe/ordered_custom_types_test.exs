defmodule Absinthe.OrderedCustomTypesTest do
  ...
  context "custom datetime type" do
    it "can use datetime type in queries" do
      ...
      assert_result {:ok, %{data: o%{"custom_types_query" =>
        o%{"datetime" => "2017-01-27T20:31:55Z"}}}}, result
    end
    it "can use datetime type in input_object" do
      ...
      assert_result {:ok, %{data: o%{"custom_types_mutation" =>
        o%{"message" => "ok"}}}}, result
    end
  ...
  context "custom naive datetime type" do
    it "can use naive datetime type in queries" do
      ...
      assert_result {:ok, %{data: o%{"custom_types_query" =>
        o%{"naive_datetime" => "2017-01-27T20:31:55"}}}}, result
    end
