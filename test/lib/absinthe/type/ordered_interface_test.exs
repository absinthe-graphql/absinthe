defmodule Absinthe.Type.OrderedInterfaceTest do
  ...
  defmodule OrderedTestSchema do
    use Absinthe.Schema
  ...
  context "interface" do
    ...
    it "can be defined" do
      obj = OrderedTestSchema.__absinthe_type__(:named)
    ...
    it "captures the relationships in the schema" do
      implementors = Map.get(OrderedTestSchema.__absinthe_interface_implementors__, :named, [])
    ...
    it "can find implementors" do
      obj = OrderedTestSchema.__absinthe_type__(:named)
      assert length(Schema.implementors(OrderedTestSchema, obj)) == 3
    end
  ...
  context "an object that implements an interface" do
    ...
    context "with the interface as a field type" do
      ...
      it "can select fields that are declared by the interface" do
        ...
        assert_result {:ok, %{data: o%{"contact" => o%{"entity" => o%{"name" => "Bruce"}}}}}, result
      end
      ...
      it "can select fields from an implementing type with 'on'" do
        ...
        """ |> Absinthe.run(ContactSchema)
        assert_result {:ok, %{data: o%{"contact" => o%{"entity" => o%{"name" => "Bruce", "age" => 35}}}}}, result
      end
  ...
  it "can query simple InterfaceSubtypeSchema" do
    ...
    assert_result {:ok, %{data: o%{"box" => o%{"item" => o%{"name" => "Computer", "cost" => 1000}}}}}, result
  end
  ...
  it "can query InterfaceSubtypeSchema treating box as HasItem" do
    ...
    """
    |> run(Absinthe.InterfaceSubtypeSchema)
    assert_result {:ok, %{data: o%{"box" => o%{"item" => o%{"name" => "Computer"}}}}}, result
  end
  ...
  it "works even when resolve_type returns nil" do
    ...
    """
    |> run(OrderedTestSchema)
    assert_result {:ok, %{data: o%{"namedThing" => o%{}}}}, result
  end
end
