defmodule Absinthe.Middleware.OrderedDataloaderTest do
  ...
  it "can resolve a field using the normal dataloader helper" do
    ...
    """
    expected_data = o(%{"users" => [
      o(%{"organization" => o(%{"name" => "Organization: #1"})}),
      o(%{"organization" => o(%{"name" => "Organization: #2"})}),
      o(%{"organization" => o(%{"name" => "Organization: #3"})})
    ]})
