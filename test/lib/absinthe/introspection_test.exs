defmodule Absinthe.IntrospectionTest do
  ...
  describe "introspection of a schema" do
    ...
    it "can use __schema to get types" do
      ...
      expected = ~w(Int ID String Boolean Float DateTime NaiveDateTime Date Contact Person Business ProfileInput SearchResult Name NamedEntity RootMutationType RootQueryType RootSubscriptionType __Schema __Directive __DirectiveLocation __EnumValue __Field __InputValue __Type) |> Enum.sort
