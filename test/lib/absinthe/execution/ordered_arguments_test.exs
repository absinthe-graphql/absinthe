defmodule Absinthe.Execution.OrderedArgumentsTest do
  ...
  context "arguments with variables" do
    ...
    context "list inputs" do
      ...
      it "works with basic scalars" do
        ...
        """
        assert_result {:ok, %{data: o%{"numbers" => [1, 2]}}}, doc |> run(Schema, variables: %{"numbers" =>[1, 2]})
      end
      ...
      it "works with custom scalars" do
        ...
        """
        assert_result {:ok, %{data: o%{"names" => ["Joe", "bob"]}}}, doc |> run(Schema, variables: %{"names" => ["Joe", "bob"]})
      end
      ...
      it "works with input objects" do
        ...
        query GetContacts($contacts:[ContactInput]){contacts(contacts:$contacts)}
        """
        assert_result {:ok, %{data: o%{"contacts" => ["a@b.com", "c@d.com"]}}}, doc |> run(Schema, variables: %{"contacts" => [%{"email" => "a@b.com"}, %{"email" => "c@d.com"}]})
      end
    end
    ...
    context "input object arguments" do
      it "works in a basic case" do
        ...
        """
        assert_result {:ok, %{data: o%{"user" => "bubba@joe.comasdf"}}}, doc |> run(Schema, variables: %{"contact" => %{"email" => "bubba@joe.com"}})
      end
    end
    ...
    context "custom scalar arguments" do
      it "works when specified as non null" do
        ...
        """
        assert_result {:ok, %{data: o%{"requiredThing" => "bob"}}}, doc |> run(Schema)
      end

      it "works when passed to resolution" do
        assert_result {:ok, %{data: o%{"something" => "bob"}}}, "{ something(name: \"bob\") }" |> run(Schema)
      end
    end
    ...
    context "boolean arguments" do
      ...
      it "are passed as arguments to resolution functions correctly" do
        ...
        """
        assert_result {:ok, %{data: o%{"something" => "YES"}}}, doc |> run(Schema, variables: %{"flag" => true})
        assert_result {:ok, %{data: o%{"something" => "NO"}}}, doc |> run(Schema, variables: %{"flag" => false})
      end
      ...
      it "If a variable is not provided schema default value is used" do
        ...
        """
        assert_result {:ok, %{data: o%{"something" => "NO"}}}, doc |> Absinthe.run(Schema, variables: %{})
      end
      ...
      it "works with input objects with inner variables" do
        ...
        """
        assert_result {:ok, %{data: o%{"contacts" => ["a@b.com", "a@b.com"]}}}, doc |> run(Schema, variables: %{"email" => "a@b.com"})
      end
      ...
      it "can set input object default values" do
        ...
        """
        assert_result {:ok, %{data: o%{"user" => "bubba@joe.comasdf"}}}, doc |> run(Schema, variables: %{"email" => "bubba@joe.com"})
      end
      ...
      it "works with lists with inner variables" do
        ...
        """
        assert_result {:ok, %{data: o%{"contacts" => ["a@b.com", "a@b.com"]}}}, doc |> run(Schema, variables: %{"contact" => %{"email" => "a@b.com"}})
      end
      ...
      it "works with lists with inner variables when no variables are given" do
        ...
        query Blah($contact: ContactInput){contacts(contacts: [$contact, $contact])}
        """
        assert_result {:ok, %{data: o%{"contacts" => []}}}, doc |> run(Schema, variables: %{})
      end
    ...
    context "nullable arguments" do
      it "if omitted should still be passed as an argument map to the resolver" do
        ...
        """
        assert_result {:ok, %{data: o%{"contact" => nil}}}, doc |> run(Schema)
      end
    end
    ...
    context "enum types" do
      it "should work with valid values" do
        ...
        """
        assert_result {:ok, %{data: o%{"contact" => "Email"}}}, doc |> run(Schema, variables: %{"type" => "Email"})
      end
      ...
      it "should work when nested" do
        ...
        """
        assert_result {:ok, %{data: o%{"user" => "bubba@joe.comasdf"}}}, doc |> run(Schema, variables: %{"contact" => %{"email" => "bubba@joe.com", "contactType" => "Email"}})
      end
  ...
  context "literal arguments" do
    ...
    context "list inputs" do
      it "works with basic scalars" do
        ...
        {numbers(numbers: [1, 2])}
        """
        assert_result {:ok, %{data: o%{"numbers" => [1, 2]}}}, doc |> run(Schema)
      end
      ...
      it "works for nested lists" do
        ...
        """
        assert_result {:ok, %{data: o%{"listOfLists" => [["foo"], ["bar", "baz"]]}}}, doc |> run(Schema)
      end
      ...
      it "it will coerce a non list item if it's of the right type" do
        ...
        {numbers(numbers: 1)}
        """
        assert_result {:ok, %{data: o%{"numbers" => [1]}}}, doc |> run(Schema)
      end
      ...
      it "works with custom scalars" do
        ...
        {names(names: ["Joe", "bob"])}
        """
        assert_result {:ok, %{data: o%{"names" => ["Joe", "bob"]}}}, doc |> run(Schema)
      end
      ...
      it "works with input objects" do
        ...
        """
        assert_result {:ok, %{data: o%{"contacts" => ["a@b.com", "c@d.com"]}}}, doc |> run(Schema)
      end
    ...
    context "input object arguments" do
      it "works in a basic case" do
        ...
        """
        assert_result {:ok, %{data: o%{"user" => "bubba@joe.comasdf"}}}, doc |> run(Schema)
      end
      ...
      it "works with inner booleans set to false" do
        ...
        """
        assert_result {:ok, %{data: o%{"testBooleanInputObject" => false}}}, doc |> run(Schema)
      end
    ...
    context "boolean arguments" do
      ...
      it "are passed as arguments to resolution functions correctly" do
        assert_result {:ok, %{data: o%{"something" => "YES"}}}, "{ something(flag: true) }" |> run(Schema)
        assert_result {:ok, %{data: o%{"something" => "NO"}}}, "{ something(flag: false) }" |> run(Schema)
        assert_result {:ok, %{data: o%{"something" => "NO"}}}, "{ something }" |> run(Schema)
      end
    ...
    context "enum types" do
      it "should work with valid values" do
        assert_result {:ok, %{data: o%{"contact" => "Email"}}}, "{ contact(type: Email) }" |> run(Schema)
      end
      it "should return an error with invalid values" do
        assert_result {:ok, %{errors: [%{message: ~s(Argument "type" has invalid value "bagel".)}]}},
          "{ contact(type: \"bagel\") }" |> run(Schema)
