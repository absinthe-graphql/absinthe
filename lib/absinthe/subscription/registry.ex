defmodule Absinthe.Subscription.Registry do
...
defmodule Absinthe.Subscription.Registry.Supervisor do
  @moduledoc false
  use Supervisor
...
defmodule Absinthe.Subscription.Registry.Partition do
  @moduledoc false
