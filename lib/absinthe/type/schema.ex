defmodule Absinthe.Type.Schema do
  @type t :: %{query:        Absinthe.Type.ObjectType.t | nil,
               mutation:     Absinthe.Type.ObjectType.t | nil,
               subscription: Absinthe.Type.ObjectType.t | nil,
               type_map:     map}
