defmodule Absinthe.Type.Interface do
  ...
  * `:resolve_type` - A function used to determine the implementing type of a resolved object. See also `Absinthe.Type.Object`'s `:is_type_of`.
  ...
  def resolve_type(%{name: name, resolve_type: nil, reference: %{identifier: ident}}, obj, %{schema: schema}) do
  ...
  def resolve_type(%{resolve_type: resolver, reference: %{identifier: ident}}, obj, %{schema: schema} = exe) do
